...
18. **模組說明文件系統(2026-09-07 提案)** — 每模組一份 `docs/modules/<module-key>.md`(業務流程、規則、建模討論結論;版控可 review);seed 時把內容灌進 module 種子(settings.help);admin AppBar 標題旁「?」按鈕開彈窗渲染 — 開發文件與使用者說明同源。
