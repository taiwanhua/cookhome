...
| Draft/AdminAppBar 元件 | root 30:95;localeSwitcher 198:50、orgSwitcher 76:54、user-menu-trigger 20:54(頭像 + 姓名 + chevron) | 語言切換 Select(值 = `localeLabels`)、當前組織 Select、使用者選單觸發區;順序與程式一致 |
